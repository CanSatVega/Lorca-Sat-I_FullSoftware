...
//Librería del sensor VEML6075 de Adafruit
...
//variables creadas para el IDE de arduino
String indice_UVA;
String indice_UVB;
String indice_UVI;

//Crea el objeto uv para el sensor VEML6075
...
void leesensores() {
  ...
  aceleracion_Z = String(fnc_adxl345(6),2);
  
  //indice_UVA  Adafruit_VEML6075();
  //indice_UVB  Adafruit_VEML6075();
  indice_UVA = uv.readUVA();
  indice_UVB = uv.readUVB();
  indice_UVI = uv.readUVI();
  ...
  s_registro = String(counter) + String(";") + String(presion) + String(";") + String(altitud) + String(";") + String(temperatura) + String(";") + String(aceleracion_Z) + String(";") + String(indice_UVA) + String(";") + String(indice_UVB) + String(";") + String(indice_UVI) + String(";") + String(longitud,8) + String(";") + String(latitud,8) + String(";") + String(velocidad) + String(";");
}
