...
void leesensores() {
  ...
  indice_UVA = uv.readUVI();
  indice_UVB = uv.readUVA();
  ...
  s_registro = String(counter) + String(";") + String(presion) + String(";") + String(altitud) + String(";") + String(temperatura) + String(";") + String(aceleracion_Z) + String(";") + String(indice_UVA) + String(";") + String(indice_UVB) + String(";") + String(indice_UVI) + String(";") + String(longitud) + String(";") + String(latitud) + String(";") + String(velocidad) + String(";");
}
